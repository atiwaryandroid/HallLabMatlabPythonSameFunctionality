...
%This function was generated by loadlibrary.m parser version 1.1.6.29 on Wed Oct  1 13:59:18 2014
...
fcns.name{fcnNum}='okDeviceSettings_Construct'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='voidPtr'; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
% void _stdcall okDeviceSettings_Destruct ( okDeviceSettings_HANDLE hnd ); 
fcns.name{fcnNum}='okDeviceSettings_Destruct'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okDeviceSettings_GetString ( okDeviceSettings_HANDLE hnd , const char * key , int length , char * buf ); 
fcns.name{fcnNum}='okDeviceSettings_GetString'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr', 'cstring', 'int32', 'cstring'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okDeviceSettings_SetString ( okDeviceSettings_HANDLE hnd , const char * key , const char * buf ); 
fcns.name{fcnNum}='okDeviceSettings_SetString'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr', 'cstring', 'cstring'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okDeviceSettings_GetInt ( okDeviceSettings_HANDLE hnd , const char * key , UINT32 * value ); 
fcns.name{fcnNum}='okDeviceSettings_GetInt'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr', 'cstring', 'uint32Ptr'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okDeviceSettings_SetInt ( okDeviceSettings_HANDLE hnd , const char * key , UINT32 value ); 
fcns.name{fcnNum}='okDeviceSettings_SetInt'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr', 'cstring', 'uint32'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okDeviceSettings_Delete ( okDeviceSettings_HANDLE hnd , const char * key ); 
fcns.name{fcnNum}='okDeviceSettings_Delete'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr', 'cstring'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okDeviceSettings_Save ( okDeviceSettings_HANDLE hnd ); 
fcns.name{fcnNum}='okDeviceSettings_Save'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='okFrontPanel_GetFPGAResetProfile'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'ulong', 'okEFPGAConfigurationMethod', 'okTFPGAResetProfilePtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='okFrontPanel_SetFPGAResetProfile'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'ulong', 'okEFPGAConfigurationMethod', 'okTFPGAResetProfilePtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='okFrontPanel_GetDeviceSettings'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'ulong', 'voidPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='okFrontPanelManager_Construct'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='voidPtr'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
% void _stdcall okFrontPanelManager_Destruct ( okCFrontPanelManager_HANDLE hnd ); 
fcns.name{fcnNum}='okFrontPanelManager_Destruct'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
% ok_ErrorCode _stdcall okFrontPanelManager_StartMonitoring ( okCFrontPanelManager_HANDLE hnd ); 
fcns.name{fcnNum}='okFrontPanelManager_StartMonitoring'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ok_ErrorCode'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
% okFrontPanel_HANDLE _stdcall okFrontPanelManager_Open ( okCFrontPanelManager_HANDLE hnd , const char * serial ); 
fcns.name{fcnNum}='okFrontPanelManager_Open'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'voidPtr', 'cstring'};fcnNum=fcnNum+1;
